    ...
    for (var key in a) {
        if (key in b) {
            if (a[key] === b[key]) {
                ...
                var typeArrayA = Object.prototype.toString.call(a[key]);
                var typeArrayB = Object.prototype.toString.call(b[key]);

                if (['[object Array]'].indexOf(typeArrayA) === 0 && ['[object Array]'].indexOf(typeArrayB) === 0) {
                    //a[key] = sort(a[key], 'uuid');
                    //b[key] = sort(b[key], 'uuid');

                    a[key] = sortByValue(a[key], b[key],'adı');
                    b[key] = sortByValue(b[key], a[key],'adı');
                }
        ...
        for (var key in diff) {
            ...
            switch (changed) {
                case 'equal':
                    ...
                    //properties.push('<span>Değişmedi </span>');
                    break;
